                ...
                <div className="container">
                    ...
                    <div className="portfolio-gallery">
                        <div className="portfolio-item">
                            <img src="/photo_2024-06-14_23-48-13.jpg" alt="Проект 1"></img>
                            <h3>Подготовка строительного участка</h3>
                            <p>подготовка территории строительстваделятся на две категории: внутриплощадочные и внеплощадочные. Каждый вид подразумевает свой перечень необходимого минимума для того, чтобы строительство домов дальнейшем было безопасным</p>
                        </div>
                        <div className="portfolio-item">
                            <img src="/photo_2024-06-14_23-48-19.jpg" alt="Проект 1"></img>
                            <h3>Монтаж зданий и сооружений из сборных конструкций</h3>
                            <p>Монтаж сборных конструкций состоит из следующих основных процессов: подготовки конструкций к подъему, строповки, подъема и установки, временного закрепления, выверки и окончательного закрепления.</p>
                        </div>
                        <div className="portfolio-item">
                            <img src="/photo_2024-06-14_23-48-22.jpg" alt="Проект 1"></img>
                            <h3>Производство изоляционных работ</h3>
                            <p>работы по перекрытию путей проникновения вод в эксплуатационный объект скважины и отключение от нее отдельных пластов и обводненных интервалов.</p>
                        </div>
                    </div>
                </div>
            </section>
